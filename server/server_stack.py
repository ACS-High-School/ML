    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        serverinitsns_step = _aws_stepfunctions_tasks.LambdaInvoke(
            ...
            payload=sfn.TaskInput.from_object({
                ...
                "sqs_region_1": server_config["clients"][0]["sqs_region_1"],
                "client_queue_name_1": server_config["clients"][0]["client_queue_name_1"],
                "sqs_region_2": server_config["clients"][1]["sqs_region_2"],
                "client_queue_name_2": server_config["clients"][1]["client_queue_name_2"],
                "sqs_region_3": server_config["clients"][2]["sqs_region_3"],
                "client_queue_name_3": server_config["clients"][2]["client_queue_name_3"],
                "sqs_region_4": server_config["clients"][3]["sqs_region_4"],
                "client_queue_name_4": server_config["clients"][3]["client_queue_name_4"],
